/**
 * Unit tests for SessionActionMenu component
 */
...
describe('SessionActionMenu Component', () => {
  const createWrapper = (props = {}) => {
    return mount(SessionActionMenu, {
      props: {
        editLabel: 'Rename',
        deleteLabel: 'Delete',
        longPressDelay: 500,
      ...
      slots: {
        default: '<div class="session-item">Session Item</div>',
      },
  ...
  describe('Component Rendering', () => {
    it('should render with default props', () => {
      ...
      expect(wrapper.find('.session-action-menu').exists()).toBe(true)
      expect(wrapper.find('.session-item').exists()).toBe(true)
      expect(wrapper.find('.session-item').text()).toBe('Session Item')
    })
  ...
  describe('Accessibility', () => {
    it('should have action buttons', () => {
      ...
      const buttons = wrapper.findAll('.session-action-menu__item')
