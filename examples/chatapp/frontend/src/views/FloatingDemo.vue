...
<template>
  <div class="floating-demo">
    ...
    <div class="demo-container">
      <h1>悬浮窗模式</h1>
      <p class="subtitle">Floating Window Mode</p>
      <p class="description">
        此模式在页面右下角显示一个悬浮球按钮，点击后打开聊天对话框。
        适用于需要节省空间、不影响主内容的场景。
      </p>
      ...
      <div class="features">
        <div class="feature">
          <h3>悬浮球按钮</h3>
          <p>页面右下角显示悬浮球，可拖动调整位置</p>
        </div>
        <div class="feature">
          <h3>弹窗对话框</h3>
          <p>点击悬浮球打开对话框，不影响页面布局</p>
        </div>
        <div class="feature">
          <h3>会话管理</h3>
          <p>支持多会话切换和管理</p>
      ...
      <div class="usage">
        ...
        <ol>
          <li>点击页面右下角的悬浮球按钮</li>
          <li>聊天对话框将从右下角弹出</li>
          <li>点击对话框外的区域可关闭对话框</li>
          <li>悬浮球可以拖动到页面任意位置</li>
        </ol>
      </div>
    </div>
