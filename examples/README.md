...
本目录展示 AI 聊天组件的三种主要使用模式，以及一个完整的聊天应用示例项目。

## 示例项目

| 项目 | 目录 | 说明 |
|------|------|------|
| **ChatApp** | `chatapp/` | 完整的前后端分离聊天应用，包含前端和后端 |

### ChatApp 示例项目

一个完整的前后端分离聊天应用，用于验证和改进 ChatBot 组件。

- **前端**: Vite + Vue 3，使用 ChatBot 组件
- **后端**: Express + TypeScript + SQLite
- **模型**: Ollama qwen3.5:9b

详细说明见 [chatapp/README.md](./chatapp/README.md)
